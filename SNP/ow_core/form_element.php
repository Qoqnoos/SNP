    ...
    public function renderInput( $params = null )
    {
        ...
        if ( $config === 'dmy' )
        {
            $result = '<div class="' . $this->getAttribute('name') . '">
                            ...
                            <div class="ow_inline">' . UTIL_HtmlTag::generateTag('select', $dayAttributes, true, $dayOptionsString) . '</div>
                            <div class="ow_inline">' . UTIL_HtmlTag::generateTag('select', $monthAttributes, true, $mounthOptionsString) . '</div>
                            <div class="ow_inline">' . UTIL_HtmlTag::generateTag('select', $yearAttributes, true, $yearOptionsString) . '</div>
                        </div>';
        }
        else
        {
...
class AgeRange extends FormElement
{
    ...
    public function renderInput( $params = null )
    {
        ...
        OW::getDocument()->addOnloadScript(" window.".$this->getName()." = new AgeRangeField( '" . ( $this->getName() ) . "', " . ( $this->minAge ) . ", " . ( $this->maxAge ) . " ); ");
...
class YearRange extends FormElement
{
    ...
    public function renderInput( $params = null )
    {
        ...
        OW::getDocument()->addScript(OW::getPluginManager()->getPlugin("base")->getStaticJsUrl() . 'age_range_field.js');
        OW::getDocument()->addOnloadScript(" window.".$this->getName()." = new AgeRangeField( '" . ( $this->getName() ) . "', " . ( $this->minYear ) . ", " . ( $this->maxYear ) . " ); ");
