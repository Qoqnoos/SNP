...
class OW_User
{
     ...
     * @return boolean
     */
    public function isAuthorized( $groupName, $actionName = null, $ownerId = null )
    {
        return BOL_AuthorizationService::getInstance()->isActionAuthorized($groupName, $actionName, $ownerId);
    }
