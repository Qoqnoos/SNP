...
class BOL_PluginService
{
    ...
    public function checkUpdates()
    {
        ...
        $postParams = array_merge(/*$data, */array('plugins' => urlencode(json_encode($pluginsRequestArray)), 'themes' => urlencode(json_encode($themesRequestArray))));
    ...
    public function getFtpConnection()
    {
        ...
        else
        {
            ...
            if ( !$ftp->isConnected() )
            {
                $errorMessageKey = 'plugins_manage_ftp_attrs_invalid_host_message';
            }

            if ( !$ftp->isLoggedIn() )
            {
                $errorMessageKey = 'plugins_manage_ftp_attrs_invalid_login_params_message';
            }
