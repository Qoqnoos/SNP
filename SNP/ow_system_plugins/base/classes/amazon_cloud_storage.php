...
class BASE_CLASS_AmazonCloudStorage implements OW_Storage
{
    ...
    public function copyFile( $sourcePath, $destPath, $requestHeaders = array() )
    {
        ...
        $obj = $this->s3->putObjectFile($sourcePath, $this->bucketName, $destPath, S3::ACL_PUBLIC_READ, array(), array_merge($this->requestHeaders, $requestHeaders));
