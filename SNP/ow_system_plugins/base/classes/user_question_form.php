...
class BASE_CLASS_UserQuestionForm extends Form
{
    ...
    public function addQuestions( $questionList, $questionValueList = array(), $questionData = array() )
    {
        foreach ( $questionList as $key => $question )
        {
            ...
            if ( in_array($question['type'], array( BOL_QuestionService::QUESTION_VALUE_TYPE_MULTISELECT, BOL_QuestionService::QUESTION_VALUE_TYPE_SELECT) ) && $question['presentation'] !== BOL_QuestionService::QUESTION_PRESENTATION_SELECT )
            {
