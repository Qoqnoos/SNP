...
class BASE_MCLASS_EventHandler extends BASE_CLASS_EventHandler
{
    ...
    /* public function onFakeMobileProfileContentMenu( BASE_CLASS_EventCollector $event )
      {
      $resultArray = array(
      BASE_MCMP_ProfileContentMenu::DATA_KEY_LABEL => "Tab 1",
      BASE_MCMP_ProfileContentMenu::DATA_KEY_LINK_HREF => "#",
      BASE_MCMP_ProfileContentMenu::DATA_KEY_LINK_CLASS => 'profile_nav_about'
      );

      $event->add($resultArray);

      $resultArray = array(
      BASE_MCMP_ProfileContentMenu::DATA_KEY_LABEL => "Tab 2",
      BASE_MCMP_ProfileContentMenu::DATA_KEY_LINK_HREF => "#",
      BASE_MCMP_ProfileContentMenu::DATA_KEY_LINK_CLASS => 'profile_nav_about'
      );
      ...
      $resultArray = array(
      BASE_MCMP_ProfileContentMenu::DATA_KEY_LABEL => "Tab 3",
      BASE_MCMP_ProfileContentMenu::DATA_KEY_LINK_HREF => "#",
      BASE_MCMP_ProfileContentMenu::DATA_KEY_LINK_CLASS => 'profile_nav_about'
      );
      ...
      $resultArray = array(
      BASE_MCMP_ProfileContentMenu::DATA_KEY_LABEL => "Tab 4",
      BASE_MCMP_ProfileContentMenu::DATA_KEY_LINK_HREF => "#",
      BASE_MCMP_ProfileContentMenu::DATA_KEY_LINK_CLASS => 'profile_nav_about'
      );
      ...
      $resultArray = array(
      BASE_MCMP_ProfileContentMenu::DATA_KEY_LABEL => "Tab 5",
      BASE_MCMP_ProfileContentMenu::DATA_KEY_LINK_HREF => "#",
      BASE_MCMP_ProfileContentMenu::DATA_KEY_LINK_CLASS => 'profile_nav_about'
      );
      ...
      $resultArray = array(
      BASE_MCMP_ProfileContentMenu::DATA_KEY_LABEL => "Tab 6",
      BASE_MCMP_ProfileContentMenu::DATA_KEY_LINK_HREF => "#",
      BASE_MCMP_ProfileContentMenu::DATA_KEY_LINK_CLASS => 'profile_nav_about'
      );
      ...
      $resultArray = array(
      BASE_MCMP_ProfileContentMenu::DATA_KEY_LABEL => "Tab 7",
      BASE_MCMP_ProfileContentMenu::DATA_KEY_LINK_HREF => "#",
      BASE_MCMP_ProfileContentMenu::DATA_KEY_LINK_CLASS => 'profile_nav_about'
      );
      ...
      $resultArray = array(
      BASE_MCMP_ProfileContentMenu::DATA_KEY_LABEL => "Tab 8",
      BASE_MCMP_ProfileContentMenu::DATA_KEY_LINK_HREF => "#",
      BASE_MCMP_ProfileContentMenu::DATA_KEY_LINK_CLASS => 'profile_nav_about'
      );
      ...
      $resultArray = array(
      BASE_MCMP_ProfileContentMenu::DATA_KEY_LABEL => "Tab 9",
      BASE_MCMP_ProfileContentMenu::DATA_KEY_LINK_HREF => "#",
      BASE_MCMP_ProfileContentMenu::DATA_KEY_LINK_CLASS => 'profile_nav_about'
      );
      ...
      $resultArray = array(
      BASE_MCMP_ProfileContentMenu::DATA_KEY_LABEL => "Tab 10",
      BASE_MCMP_ProfileContentMenu::DATA_KEY_LINK_HREF => "#",
      BASE_MCMP_ProfileContentMenu::DATA_KEY_LINK_CLASS => 'profile_nav_about'
      );
      ...
      $resultArray = array(
      BASE_MCMP_ProfileContentMenu::DATA_KEY_LABEL => "Tab 11",
      BASE_MCMP_ProfileContentMenu::DATA_KEY_LINK_HREF => "#",
      BASE_MCMP_ProfileContentMenu::DATA_KEY_LINK_CLASS => 'profile_nav_about'
      );
      ...
      $resultArray = array(
      BASE_MCMP_ProfileContentMenu::DATA_KEY_LABEL => "Tab 12",
      BASE_MCMP_ProfileContentMenu::DATA_KEY_LINK_HREF => "#",
      BASE_MCMP_ProfileContentMenu::DATA_KEY_LINK_CLASS => 'profile_nav_about'
      );
    ...
    public function onDocRenderAddJsDeclarations( $e )
    {
        ...
        if ( OW::getUser()->isAuthenticated() )
        {
            ...
            $params = array(
                ...
                'lastFetchTime' => time(),
                'pingInterval' => 10,
                'disabledMessage' => OW::getLanguage()->text('base', 'mobile_disabled_item_message', array('url' => $desktopUrl))
            );
    ...
    public function onActionToolbarAddUserBlockActionTool( BASE_CLASS_EventCollector $event )
    {
        ...
        $js->jQueryEvent("#" . $uniqId, "click",
            'OWM.Users[$(this).attr("data-command") == "block" ? "blockUser" : "unBlockUser"](e.data.userId);
